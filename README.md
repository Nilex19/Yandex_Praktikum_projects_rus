...
| [15_Final_Forecast_churn_of_the_telecom_operator_clients](Project_15_Final_Forecast_churn_of_the_telecom_operator_clients) | Прогнозирование оттока клиентов телекоммуникационной компании. | *Pandas*, *Matplotlib*, *Seaborn*, *Numpy*, *Sklearn*, *Imblearn*, *Lightgbm*, *Xgboost*, *Catboost* |
